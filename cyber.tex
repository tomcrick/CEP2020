...
\title{The Challenges of Teaching Cybersecurity in UK Computer Science
Degree Programmes}
...
%TO DO Will you vary this, or develop it further?
As indicated in the previous section there are a number of challenges
that have not been fully addressed, with a significant opportunity for
the UK higher education sector to take the lead:
\begin{enumerate}
...
Most HEIs in the UK now include cybersecurity
in their general computer science provision in the same manner that
they include programming; it is now time to
consider how to further enhance the quality of provision. Perhaps cybersecurity should
receive the same level of attention in terms of pedagogic research and
practice as say programming or CS1?
